...
- **Work with any MCP server** - IRIS Prime, Supabase, Claude Flow, etc.
...
- [IRIS Prime MCP Client](/home/iris/code/experimental/iris-prime-console/src/mcp/README.md)
...
**Generated by IRIS Prime MCP Wrapper Generator**
